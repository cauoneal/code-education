...
class CodeProjectRepositoryProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
                \CodeProject\Repositories\ProjecNoteRepository::class,
                \CodeProject\Repositories\ProjecNoteRepositoryEloquent::class);
        $this->app->bind(
                \CodeProject\Repositories\ProjectTaskRepository::class,
                \CodeProject\Repositories\ProjectTaskRepositoryEloquent::class);
        $this->app->bind(\CodeProject\Repositories\ProjectMembersRepository::class,
